...
//Runtime mesh component is far more efficient than the PRocedural mesh component. Contains everything procedural has including slicing feature.
//supports tessellation and navigation(AI)
//Runtime uses minimal resources like memory (if any at all)
...
//inherit PostActorCreated functions from parent
void ACubeActor1::PostActorCreated()
{
	Super::PostActorCreated();
	GenerateBoxMesh();
}
//inherit PostLoad functions from parent
void ACubeActor1::PostLoad()
{
	Super::PostLoad();
	GenerateBoxMesh();
}
...
{
	FVector BoxVerts[8]; //changed to 8; why would the tutorial use 4 when there are clearly 8 members in the below array?
